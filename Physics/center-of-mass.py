'''
Demonstration of the center of mass.
'''
from browser import *
from easel import *
from three import *
...
giant.momentum = VectorE3(0, -0.5, 1) * giant.mass
space3D.add(giant)
...
com = SphereBuilder().color("white").radius(0.1).build()
space3D.add(com)
...
def tick(t):
    ...
    com.position = (giant.position * giant.mass + dwarf.position * dwarf.mass) / (giant.mass + dwarf.mass)
