...
space.add(SphereBuilder().color(0xFF0000).volume(1).build().translateX(+3).translateY(-3))
space.add(ConeBuilder().color(0xFFFF00).volume(1).build().translateX(-3).translateY(+3))
space.add(ArrowBuilder().color(0xFFFFFF).segments(12).scale(8).build())
