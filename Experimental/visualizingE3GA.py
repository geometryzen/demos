...
space3D.camera.position = 3.0 * (e1 + 1.5 * e2 + 1.3 * e3).normalize()
...
#composite.add(cube)
arrow = ArrowBuilder().axis(+e1).wireframe(True).color(colorB).build()
arrow.position = VectorE3(+0.0, -0.5, +0.5)
composite.add(arrow)
arrow = ArrowBuilder().axis(-e1).wireframe(True).color(colorB).build()
arrow.position = VectorE3(+0.0, +0.5, -0.5)
composite.add(arrow)
arrow = ArrowBuilder().axis(+e2).wireframe(True).color(colorB).build()
arrow.position = VectorE3(+0.5, +0.0, -0.5)
composite.add(arrow)
arrow = ArrowBuilder().axis(-e2).wireframe(True).color(colorB).build()
arrow.position = VectorE3(-0.5, +0.0, +0.5)
composite.add(arrow)
arrow = ArrowBuilder().axis(+e3).wireframe(True).color(colorB).build()
