...
quantity = ScalarE3(1) + VectorE3(0, 0, 4) + BivectorE3(1,0,0) + PseudoscalarE3(1)
...
grade2 = VortexBuilder().wireframe(True).width(0.5).height(0.01).color(0x0000FF).segments(32).build()
