...
#    scene.add(mesh)
    ...
    mesh = Mesh(CubeGeometry(5, 0.1, 5), material(0x0000FF, 0.25))
...
shape = ArrowBuilder().scale(10).attitude(rotor).segments(24).material(material(0xFF0000, 0.25)).build()
scene.add(shape)
