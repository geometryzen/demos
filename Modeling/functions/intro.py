...
xLabel = b.create('text',[(maxX+minX)/2, (minY+box[3])/2, 'Extension/( %s )' % meter], {"fontSize":15,"anchorX":'middle',"anchorY":'middle'})
yLabel = b.create('text',[minX, (maxY+minY)/2, 'Energy/( %s )' % f(ScalarE3(1) * meter).uom], {"fontSize":15, "display":'internal', "rotate":90,"anchorX":'middle',"anchorY":'middle'})
