...
var board = graph.initBoard("box", {boundingbox:[-1,-1,3,2],axis:true, grid:true, keepaspectratio: true, showCopyright:false, showNavigation:true, document: popUp.document});
